...
#include "../src/mc_discr_arith_av_price_const.hpp"
...
int main(int argc, char* argv[]){
    ...
    try{
        ...
        */
        ...
        mcengine1 = MakeMCDiscreteArithmeticAPEngine <PseudoRandom>(bsmProcess)
        ...
        mcengine1c = MakeMCDiscreteArithmeticAPConstEngine <PseudoRandom>(bsmProcess, true)
            .withAbsoluteTolerance(0.02)
            .withSeed(mcSeed);
        asianOption.setPricingEngine(mcengine1c);
        ...
        mcengine2 = MakeMCDiscreteArithmeticAPEngine <LowDiscrepancy>(bsmProcess)
        ...
        mcengine2c = MakeMCDiscreteArithmeticAPConstEngine <LowDiscrepancy>(bsmProcess, true)
            .withSamples(nSamples);
                 
        asianOption.setPricingEngine(mcengine2c);
        t1 = clock();
        res = asianOption.NPV();     
        t2 = clock();
